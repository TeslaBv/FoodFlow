...
<html>
    ...
    <body>
        ...
        <div class="crud-container">
            <button type="button" class="btn-add" onclick="window.location.href='/crudusuario/pages/admin/registrarusuario.jsp'">Agregar Nuevo Usuario</button>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button class="btn-edit" onclick="window.location.href='/crudusuario/pages/admin/editarusuario.jsp?id=<%= usuario.getId() %>'">Editar</button>
